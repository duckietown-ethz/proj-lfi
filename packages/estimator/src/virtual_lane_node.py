...
class VirtualLaneNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        self.parameters['~end_angle_deg_left'] = None
        self.parameters['~end_distance_straight'] = None
    ...
    def publish_closest(self, pos1, pos2):
        ...
        marker.points = [utils.pos_to_point(pos1), utils.pos_to_point(pos2)]
        marker.color = utils.gen_color(0,1,0)
        marker.colors = []
    ...
    def publish_track(self, track, tangent_angle):
        ...
        track_marker.points = list([utils.pos_to_point(pos) for pos in track])
        track_marker.colors = list([utils.gen_color(0,0,1) for _ in track])
